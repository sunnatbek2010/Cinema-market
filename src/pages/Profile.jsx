  ...
  return (
    <div className="min-h-screen bg-[#101029] text-white px-12 py-10 w-full">
      <div className="max-w-7xl mx-auto flex gap-10">
        ...
        <div className="flex-1 bg-[#1E1E37] rounded-xl p-8">
          ...
          <div className="flex-1 bg-[#1E1E37] rounded-xl p-8">
            ...
            <div className="flex flex-col gap-4 max-w-md">
              ...
              <button className="mt-3 bg-gradient-to-r from-blue-600 to-fuchsia-600 hover:opacity-90 transition rounded-full py-3 font-semibold">
                Save changes
              </button>
            </div>
          </div>
